...
fixture="$repo_root/haskell/test/prepared-stg/PreparedStgProbe.hs"
resident_fixture="$repo_root/haskell/test/prepared-stg/ResidentPreparedProbe.hs"
resident_iface_writer="$repo_root/haskell/test/prepared-stg/MakeResidentIface.hs"
include="$repo_root/haskell/test/prepared-stg"
required_inventory="$repo_root/haskell/test-prepared-stg/required-inventory.fragments"
...
runghc -package=ghc -i"$repo_root/haskell/src" "$resident_iface_writer" \
