...
(`exomonad/worktree/CLAUDE.md`): cancellation settles and deletes nothing.
...
```bash
codex app-server generate-json-schema --out exomonad/agent/fixtures/app-server-0.146.0/
```
