...
pub enum Probe {
    ...
    WorldRenamed,
    WorldPacket,
    WorldPacketMembership,
    ExomonadRoute,
    ExomonadRouteNoMatch,
    ExomonadAttentionUrgent,
    ExomonadAttentionRoutine,
    ExomonadExpand,
    ExomonadFoldGap,
    ExomonadEvidence,
    ExomonadEvidenceMissing,
    ExomonadQuestionDuplicate,
    ExomonadQuestionDistinct,
    ExomonadRepair,
    ExomonadRepairUnavailable,
    ExomonadExperiment,
    ExomonadExperimentInsufficient,
    Structured,
    StateNull,
    StateArray,
    StateNumber,
...
impl Probe {
    ...
    pub fn request(self, model: &str) -> Value {
        ...
        match self {
            Self::WorldConflict => return crate::worlds::swarm(model, false, false),
            Self::WorldLocal => return crate::worlds::swarm(model, true, false),
            Self::WorldRenamed => return crate::worlds::swarm(model, false, true),
            Self::WorldPacket => return crate::worlds::packet(model),
            Self::WorldPacketMembership => return crate::worlds::packet_membership(model),
            Self::ExomonadRoute => return crate::scenarios::route(model, false),
            Self::ExomonadRouteNoMatch => return crate::scenarios::route(model, true),
            Self::ExomonadAttentionUrgent => return crate::scenarios::attention(model, false),
            Self::ExomonadAttentionRoutine => return crate::scenarios::attention(model, true),
            Self::ExomonadExpand => return crate::scenarios::investigate(model, false),
            Self::ExomonadFoldGap => return crate::scenarios::investigate(model, true),
            Self::ExomonadEvidence => return crate::scenarios::evidence(model, false),
            Self::ExomonadEvidenceMissing => return crate::scenarios::evidence(model, true),
            Self::ExomonadQuestionDuplicate => return crate::scenarios::relate(model, false),
            Self::ExomonadQuestionDistinct => return crate::scenarios::relate(model, true),
            Self::ExomonadRepair => return crate::scenarios::repair(model, false),
            Self::ExomonadRepairUnavailable => return crate::scenarios::repair(model, true),
            Self::ExomonadExperiment => return crate::scenarios::experiment(model, false),
            Self::ExomonadExperimentInsufficient => {
                return crate::scenarios::experiment(model, true)
            }
            Self::Structured => {
