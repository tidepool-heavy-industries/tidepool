...
| Tidepool host release build (excludes a cold Codex build) | `nix build 'path:.#exomonad-unwrapped' --no-link` from an uncached changed source | Approximately 15 minutes; Nix built the filtered Cargo vendor input and `exomonad-unwrapped` |
