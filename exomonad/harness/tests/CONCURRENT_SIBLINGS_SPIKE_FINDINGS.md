...
The FIFO ready queue and thread table (`exomonad/harness/src/selfharness/driver/green.rs`)
...
- `exomonad/harness/src/selfharness/driver/green.rs:896-941` (inside
...
- `exomonad/harness/src/selfharness/driver/lifecycle.rs:1448-1478` (the
...
- Confirmed independently by `exomonad/harness/tests/answerer_async_fork.rs`'s
...
- `exomonad/harness/src/selfharness/driver/lifecycle.rs:1283-1301` — the
...
- `exomonad/harness/src/selfharness/driver/green.rs:1163-1297`
...
Both sites live in `exomonad/harness/src/selfharness/driver/{lifecycle,green}.rs`,
outside this spec's ALLOWED PATHS (`bridge/haskell/lib/Tidepool/Swarm.hs`,
`bridge/haskell/test`, `exomonad/harness/tests`, `tidepool-testing`) — this is
driver-team follow-up work, not something this spec could implement even if
it tried.

## What was deliberately NOT done

No changes to `bridge/haskell/lib/Tidepool/Swarm.hs` (`hyloM` untouched, no additive
...
`bridge/haskell/lib/Tidepool/Agent/Spawn.hs`: `spawnAgent spec = spawnAsync spec >>=
...
`SubagentSpawnAsync` (`bridge/handlers/src/handlers/agent.rs`'s
...
`sum`. Pinned by `exomonad/harness/tests/outer_subagent.rs`'s
