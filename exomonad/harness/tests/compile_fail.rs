...
//! see each fixture's own comment for which guarantee it pins. `.stderr`
//! goldens are rustc-version-sensitive; the toolchain here is nix-pinned, so
//! a future toolchain bump is the trigger to regenerate them
