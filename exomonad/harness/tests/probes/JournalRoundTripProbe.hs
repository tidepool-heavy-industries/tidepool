...
childPlan1 = DevPlan { nodeName = "c1", nodeTask = "t1", nodeChecks = [], nodeBoundary = [], nodeTolerated = [], nodeOnFailure = Retry, nodeSplit = Nothing, nodeScaffold = Nothing, childPlans = [], nodeCycles = Nothing }
childPlan2 = DevPlan { nodeName = "c2", nodeTask = "t2", nodeChecks = [], nodeBoundary = [], nodeTolerated = [], nodeOnFailure = Retry, nodeSplit = Nothing, nodeScaffold = Nothing, childPlans = [], nodeCycles = Nothing }

parentPlan :: DevPlan
parentPlan = DevPlan { nodeName = "parent", nodeTask = "t", nodeChecks = [], nodeBoundary = [], nodeTolerated = [], nodeOnFailure = Retry, nodeSplit = Nothing, nodeScaffold = Nothing, childPlans = [childPlan1, childPlan2], nodeCycles = Nothing }
