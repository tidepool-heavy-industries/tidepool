...
//! under `exomonad/worktree/src`, transitive closure of every type reachable
//! from each)
//!
...
// --- golden plumbing, mirroring bridge/handlers/tests/bridged_records.rs --
...
fn worktree_receipt_field_shape_is_pinned_inline() {
    ...
    assert_eq!(
        ...
        "WorktreeReceipt's serde shape (field names, field order, or the \
         ...
         machines (exomonad/worktree/src/registry.rs); if this change is \
...
fn binding_field_shape_is_pinned_inline() {
    ...
    assert_eq!(
        ...
        "Binding's serde shape (field names, field order, or the BindingState \
         ...
         (exomonad/worktree/src/binding.rs); if this change is deliberate, \
...
fn worktree_error_field_shape_is_pinned_inline() {
    ...
    assert_eq!(
        ...
        "WorktreeError's serde shape (variant tag or field names/order) \
         ...
         not itself durable JSON (exomonad/worktree/src/error.rs — see this \
