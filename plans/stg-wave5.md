...
The exact-interface test compiles but its first fat binding lookup reports
NoExtraDeclarations. The fixture is expected to have extra declarations; its
compiler/load sequence is under Terra review. B2 body preparation has not yet
been demonstrated. The two new CAF execution tests remain intentional red
acceptance seeds pending wiring. Full fixture freshness/corpus replay remains
for the integration fold.
