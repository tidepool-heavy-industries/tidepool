...
compile memo already excludes by design (`plans/compile-memo.md`, hazard b)
...
**Bottom line on duplication:** the compile memo (already landed,
`plans/compile-memo.md`) is doing its job on the FIXED-template slice
