...
const OVERSPEND_REGRESSION_SOURCE: &str = concat!(
    ...
    "\n",
    "leafPlan :: DevPlan\n",
    "leafPlan = DevPlan { nodeName = \"leaf\", nodeTask = \"t\", nodeChecks = [], nodeBoundary = [], nodeTolerated = [], nodeOnFailure = Retry, nodeSplit = Nothing, childPlans = [], nodeCycles = Nothing }\n",
    "\n",
    "rootPlan :: DevPlan\n",
    "rootPlan = DevPlan { nodeName = \"root\", nodeTask = \"t\", nodeChecks = [], nodeBoundary = [], nodeTolerated = [], nodeOnFailure = Retry, nodeSplit = Nothing, childPlans = [leafPlan, leafPlan], nodeCycles = Nothing }\n",
    "\n",
