...
const RESUME_DECISION_SOURCE: &str = concat!(
    ...
    "\n",
    "leafPlan :: DevPlan\n",
    "leafPlan = DevPlan { nodeName = \"leaf\", nodeTask = \"implement the leaf\", nodeChecks = [], nodeBoundary = [], nodeOnFailure = Retry, nodeSplit = Nothing, childPlans = [] }\n",
    "\n",
    "leafBranch :: Text\n",
...
const OVERSPEND_REGRESSION_SOURCE: &str = concat!(
    ...
    "\n",
    "leafPlan :: DevPlan\n",
    "leafPlan = DevPlan { nodeName = \"leaf\", nodeTask = \"t\", nodeChecks = [], nodeBoundary = [], nodeOnFailure = Retry, nodeSplit = Nothing, childPlans = [] }\n",
    "\n",
    "rootPlan :: DevPlan\n",
    "rootPlan = DevPlan { nodeName = \"root\", nodeTask = \"t\", nodeChecks = [], nodeBoundary = [], nodeOnFailure = Retry, nodeSplit = Nothing, childPlans = [leafPlan, leafPlan] }\n",
    "\n",
...
const JOURNAL_ROUND_TRIP_SOURCE: &str = concat!(
    ...
    "childPlan1 = DevPlan { nodeName = \"c1\", nodeTask = \"t1\", nodeChecks = [], nodeBoundary = [], nodeOnFailure = Retry, nodeSplit = Nothing, childPlans = [] }\n",
    "childPlan2 = DevPlan { nodeName = \"c2\", nodeTask = \"t2\", nodeChecks = [], nodeBoundary = [], nodeOnFailure = Retry, nodeSplit = Nothing, childPlans = [] }\n",
    "\n",
    "parentPlan :: DevPlan\n",
    "parentPlan = DevPlan { nodeName = \"parent\", nodeTask = \"t\", nodeChecks = [], nodeBoundary = [], nodeOnFailure = Retry, nodeSplit = Nothing, childPlans = [childPlan1, childPlan2] }\n",
    "\n",
