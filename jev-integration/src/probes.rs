...
pub enum Probe {
    ...
    ShoalRoute,
    ShoalRouteNoMatch,
    ShoalAttentionUrgent,
    ShoalAttentionRoutine,
    ShoalExpand,
    ShoalFoldGap,
    ShoalEvidence,
    ShoalEvidenceMissing,
    ShoalQuestionDuplicate,
    ShoalQuestionDistinct,
    ShoalRepair,
    ShoalRepairUnavailable,
    ShoalExperiment,
    ShoalExperimentInsufficient,
    Structured,
    StateNull,
    StateArray,
    StateNumber,
...
impl Probe {
    ...
    pub fn request(self, model: &str) -> Value {
        ...
        match self {
            ...
            Self::ShoalRoute => return crate::scenarios::route(model, false),
            Self::ShoalRouteNoMatch => return crate::scenarios::route(model, true),
            Self::ShoalAttentionUrgent => return crate::scenarios::attention(model, false),
            Self::ShoalAttentionRoutine => return crate::scenarios::attention(model, true),
            Self::ShoalExpand => return crate::scenarios::investigate(model, false),
            Self::ShoalFoldGap => return crate::scenarios::investigate(model, true),
            Self::ShoalEvidence => return crate::scenarios::evidence(model, false),
            Self::ShoalEvidenceMissing => return crate::scenarios::evidence(model, true),
            Self::ShoalQuestionDuplicate => return crate::scenarios::relate(model, false),
            Self::ShoalQuestionDistinct => return crate::scenarios::relate(model, true),
            Self::ShoalRepair => return crate::scenarios::repair(model, false),
            Self::ShoalRepairUnavailable => return crate::scenarios::repair(model, true),
            Self::ShoalExperiment => return crate::scenarios::experiment(model, false),
            Self::ShoalExperimentInsufficient => return crate::scenarios::experiment(model, true),
            Self::Structured => {
