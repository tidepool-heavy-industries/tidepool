...
reportProgress remainingQuestions
...
(consumer, consumerQuestions) <- unfold (taskGroup assignment) (childWithProgress @Attention @(Outcome Candidate) (withContext (selected taskContext) (solTask consumerLabel assignment)))
