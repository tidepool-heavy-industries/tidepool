    ...
    let tree = RecursiveTree {
        nodes: vec![
            ...
            CoreFrame::Case {
                ...
                alts: vec![
                    Alt {
                        con: AltCon::LitAlt(Literal::LitDouble(one_bits)),
                        binders: vec![],
                        body: 1,
                    },
                    Alt {
                        con: AltCon::LitAlt(Literal::LitDouble(val_bits)),
                        binders: vec![],
                        body: 2,
                    },
                    Alt {
    ...
    let tree = RecursiveTree {
        nodes: vec![
            ...
            CoreFrame::Case {
                ...
                alts: vec![
                    Alt {
                        con: AltCon::LitAlt(Literal::LitFloat(one_bits)),
                        binders: vec![],
                        body: 1,
                    },
                    Alt {
                        con: AltCon::LitAlt(Literal::LitFloat(target_bits)),
                        binders: vec![],
                        body: 2,
                    },
                    Alt {
    ...
    let tree = RecursiveTree {
        nodes: vec![
            ...
            CoreFrame::Case {
                ...
                alts: vec![
                    Alt {
                        con: AltCon::DataAlt(true_id),
                        binders: vec![],
                        body: 1,
                    },
                    Alt {
                        con: AltCon::DataAlt(false_id),
                        binders: vec![],
                        body: 2,
                    },
                ],
    ...
    let tree = RecursiveTree {
        nodes: vec![
            ...
            CoreFrame::Case {
                ...
                alts: vec![
                    Alt {
                        con: AltCon::LitAlt(Literal::LitWord(0)),
                        binders: vec![],
                        body: 1,
                    },
                    Alt {
    ...
    let tree = RecursiveTree {
        nodes: vec![
            ...
            CoreFrame::Case {
                ...
                alts: vec![
                    Alt {
                        con: AltCon::LitAlt(Literal::LitChar('a')),
                        binders: vec![],
                        body: 1,
                    },
                    Alt {
