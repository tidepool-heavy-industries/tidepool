...
pub use gc::{
    arm_gc_fault, clear_rust_roots, gc_doubling_run_count, gc_trigger, gc_trigger_call_count,
    gc_trigger_last_vmctx, heap_verify_run_count, persistent_roots_count, register_persistent_root,
    register_rust_root, reset_test_counters, rust_roots_mark, set_gc_poison, set_heap_verify,
    truncate_rust_roots, GcFaultPoint,
};
