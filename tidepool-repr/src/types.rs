...
pub enum PrimOpKind {
    ...
    DoubleNegate, // unary
    DoubleFabs,   // unary
    // --- Tier 2: Double math (Floating class) ---
    DoubleSqrt,
    DoubleExp,
    DoubleExpM1,
    DoubleLog,
...
impl std::fmt::Display for PrimOpKind {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let name = match self {
            ...
            PrimOpKind::DoubleFabs => "fabsDouble#",
            PrimOpKind::DoubleSqrt => "sqrtDouble#",
            PrimOpKind::DoubleExp => "expDouble#",
            PrimOpKind::DoubleExpM1 => "expm1Double#",
            PrimOpKind::DoubleLog => "logDouble#",
            PrimOpKind::DoubleLog1P => "log1pDouble#",
            PrimOpKind::DoubleSin => "sinDouble#",
            PrimOpKind::DoubleCos => "cosDouble#",
            PrimOpKind::DoubleTan => "tanDouble#",
            PrimOpKind::DoubleAsin => "asinDouble#",
            PrimOpKind::DoubleAcos => "acosDouble#",
            PrimOpKind::DoubleAtan => "atanDouble#",
            PrimOpKind::DoubleSinh => "sinhDouble#",
            PrimOpKind::DoubleCosh => "coshDouble#",
            PrimOpKind::DoubleTanh => "tanhDouble#",
            PrimOpKind::DoubleAsinh => "asinhDouble#",
            PrimOpKind::DoubleAcosh => "acoshDouble#",
            PrimOpKind::DoubleAtanh => "atanhDouble#",
