...
/// Repo root, derived from this crate's manifest dir (`<root>/bridge/testing`).
pub fn repo_root() -> PathBuf {
    ...
    Path::new(env!("CARGO_MANIFEST_DIR"))
        ...
        .expect("bridge/testing has two parents (repo root)")
        .to_path_buf()
}
...
-- codegen time (see bridge/mcp/src/effect_defs.rs); this static preamble
