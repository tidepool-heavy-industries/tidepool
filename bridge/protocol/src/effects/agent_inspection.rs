...
pub fn agent_inspection() -> Effect {
    Effect {
        ...
        type_defs: vec![
            TypeDef {
                name: "ObservationShareResult", wire_rust: None, haskell_module: None,
            ...
            TypeDef {
                name: "ProviderFailureKind", wire_rust: None, haskell_module: None,
            ...
            TypeDef {
                name: "ProviderHealth", wire_rust: None, haskell_module: None,
            ...
            TypeDef {
                name: "AgentDisposition", wire_rust: None, haskell_module: None,
                shape: TypeShape::Sum { variants: vec![
