...
mod tests {
    ...
    fn example_skills() -> PathBuf {
        Path::new(env!("CARGO_MANIFEST_DIR")).join("../../exomonad/examples/workspace/.shoal/skills")
    }
    ...
    fn the_scaffolded_haskell_is_the_repositorys_own() {
        ...
        for (relative, expected) in [
            (
                ...
                include_str!("../../../exomonad/examples/workspace/.shoal/Jev/Operators.hs"),
            ),
            (
                ".shoal/AgentSpec.hs",
                include_str!("../../../exomonad/examples/workspace/.shoal/AgentSpec.hs"),
            ),
            (
                ".shoal/Project/Tools.hs",
                include_str!("../../../exomonad/examples/workspace/.shoal/Project/Tools.hs"),
            ),
            (
