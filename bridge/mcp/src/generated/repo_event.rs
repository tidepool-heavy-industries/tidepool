//! `RepoEvent` effect declaration — GENERATED by tidepool-protocol, DO NOT EDIT. Regenerate: `cargo run -p tidepool-protocol --bin tidepool-protocol-gen` (see bridge/protocol/src/gen/mod.rs).
...
pub fn event_decl() -> crate::EffectDecl {
    crate::EffectDecl {
        ...
        type_defs: &[
            ...
            "data SubscriptionId = SubscriptionId Text deriving (Show, Eq)",
            "data MailboxId = MailboxId Text deriving (Show, Eq)",
            "data EventWatch = WatchCommit WorktreeId | WatchHead WorktreeId | WatchDeadline Int | WatchAsync Int | WatchMailbox MailboxId deriving (Show, Eq)",
            ...
            "data RepositoryEvent = ObservedCommit EventId CommitReceipt | ObservedHeadChange EventId HeadChangeReceipt | ObservedTick EventId Tick | ObservedAsyncDone EventId Int | ObservedMessage EventId MailboxId Value deriving (Show, Eq)",
            "data EventError = EventQueueOverflow Text Int | EventUnknownSubscription Text | EventSubscriptionDenied Text Text Text Text | EventSourceLost Text | EventSourceFailed Text | EventUnknownMailbox Text | EventMailboxDenied Text Text Text Text deriving (Show, Eq)\ninstance ToJSON EventError where\n  toJSON e = case e of\n    EventQueueOverflow overflowSub dropped -> object [\"tag\" .= (\"EventQueueOverflow\" :: Text), \"overflowSub\" .= overflowSub, \"dropped\" .= dropped]\n    EventUnknownSubscription unknownSub -> object [\"tag\" .= (\"EventUnknownSubscription\" :: Text), \"unknownSub\" .= unknownSub]\n    EventSubscriptionDenied deniedOperation deniedSub deniedOwner deniedCaller -> object [\"tag\" .= (\"EventSubscriptionDenied\" :: Text), \"deniedOperation\" .= deniedOperation, \"deniedSub\" .= deniedSub, \"deniedOwner\" .= deniedOwner, \"deniedCaller\" .= deniedCaller]\n    EventSourceLost lostDetail -> object [\"tag\" .= (\"EventSourceLost\" :: Text), \"lostDetail\" .= lostDetail]\n    EventSourceFailed failedDetail -> object [\"tag\" .= (\"EventSourceFailed\" :: Text), \"failedDetail\" .= failedDetail]\n    EventUnknownMailbox unknownMailbox -> object [\"tag\" .= (\"EventUnknownMailbox\" :: Text), \"unknownMailbox\" .= unknownMailbox]\n    EventMailboxDenied mailboxOperation deniedMailbox mailboxOwner mailboxCaller -> object [\"tag\" .= (\"EventMailboxDenied\" :: Text), \"mailboxOperation\" .= mailboxOperation, \"deniedMailbox\" .= deniedMailbox, \"mailboxOwner\" .= mailboxOwner, \"mailboxCaller\" .= mailboxCaller]\n",
        ],
        extra_imports: &[
