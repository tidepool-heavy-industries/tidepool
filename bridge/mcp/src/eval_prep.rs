...
//!
//! Failure classification and rendering belong to `tidepool_runtime`, shared
...
/// `bridge/mcp/CLAUDE.md`'s generated-effects section). Its text never
...
pub(crate) fn effects_core_module_source_for(vocab_effects: &[EffectDecl]) -> String {
    ...
    out.push_str("-- see bridge/mcp/CLAUDE.md's generated-effects section.\n");
...
pub fn effects_shim_module_source(row_effects: &[EffectDecl], row: &crate::RowArgs) -> String {
    ...
    out.push_str("-- bridge/mcp/CLAUDE.md's generated-effects section.\n");
