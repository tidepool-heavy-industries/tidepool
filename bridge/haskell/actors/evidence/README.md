...
```
ghci -ibridge/haskell/actors/evidence -iplans/next bridge/haskell/actors/evidence/Review.hs
```
...
```
runghc -Wall -Werror -ibridge/haskell/actors/evidence -iplans/next bridge/haskell/actors/evidence/Tests.hs
```
...
```
runghc -Wall -Werror -ibridge/haskell/actors/evidence -iplans/next bridge/haskell/actors/evidence/RetainedSurvey.hs
```
