Use this project's Haskell workbench and normal native coding tools. The Haskell
...
preserves it. Watch pending results and cumulative questions, then end the turn.
