//! `Introspection` suspension request type — GENERATED by tidepool-protocol, DO NOT EDIT. Regenerate: `cargo run -p tidepool-protocol --bin tidepool-protocol-gen` (see tidepool-protocol/src/gen/mod.rs).

use tidepool_bridge_derive::FromCore;

/// One variant per `Introspection` GADT constructor, named EXACTLY as in Haskell.
...
pub enum IntrospectionReq {
    IntrospectionInfoWith(tidepool_eval::value::Value),
    IntrospectionTypeOfWith(tidepool_eval::value::Value),
}
