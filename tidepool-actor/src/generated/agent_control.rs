//! `AgentControl` suspension request type — GENERATED by tidepool-protocol, DO NOT EDIT. Regenerate: `cargo run -p tidepool-protocol --bin tidepool-protocol-gen` (see tidepool-protocol/src/gen/mod.rs).

use tidepool_bridge_derive::FromCore;

/// One variant per `AgentControl` GADT constructor, named EXACTLY as in Haskell.
...
pub enum AgentControlReq {
    AgentControlTryCallWith((i64, i64), tidepool_eval::value::Value),
}
