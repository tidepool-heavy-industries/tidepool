//! `Lookup` suspension request type — GENERATED by tidepool-protocol, DO NOT EDIT. Regenerate: `cargo run -p tidepool-protocol --bin tidepool-protocol-gen` (see tidepool-protocol/src/gen/mod.rs).

use tidepool_bridge_derive::FromHaskell;

/// One variant per `Lookup` GADT constructor, named EXACTLY as in Haskell.
...
pub enum LookupReq {
    LookupRaw(tidepool_bridge::HaskellValue),
}
