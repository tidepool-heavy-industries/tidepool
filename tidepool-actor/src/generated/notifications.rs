//! `Notifications` suspension request type — GENERATED by tidepool-protocol, DO NOT EDIT. Regenerate: `cargo run -p tidepool-protocol --bin tidepool-protocol-gen` (see tidepool-protocol/src/gen/mod.rs).

use tidepool_bridge_derive::FromCore;

/// One variant per `Notifications` GADT constructor, named EXACTLY as in Haskell.
...
pub enum NotificationsReq {
    NotifyWith((i64, i64), String),
    PollNotificationWith(((i64, i64), ((i64, i64), (String, i64)))),
}
