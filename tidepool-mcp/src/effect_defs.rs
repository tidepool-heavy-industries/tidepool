    ...
    ($project:path) => {
        $project! {
            ...
            verbs [
                ...
                { ctor TryFsRead, method fs_try_read,
                  args { path: "Text" as String },
                  ret "(Either Text Text)" },
