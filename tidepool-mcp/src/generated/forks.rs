...
pub fn forks_decl() -> crate::EffectDecl {
    crate::EffectDecl {
        ...
        constructors: &[
            ...
            "ForksStartWith :: Text -> (Int -> Eff childEffs ()) -> Int -> ActorLaunchRole -> ActorEffectProfile -> [Text] -> Maybe WorktreeSpec -> DirtyPolicy -> [ActorEffectKey] -> Maybe ForkEffort -> Maybe (Int, Int) -> Maybe Model -> ForkContext -> Maybe Text -> WorkerLifetime -> Forks (Either Text ((Int, Int, Text), WorktreeHandle))",
        ...
        type_defs: &[
            ...
            "data ActorEffectKey = EffectReplies | EffectWatches | EffectForks | EffectActorContext | EffectAgentLaunch | EffectAgentInspection | EffectAgentControl | EffectBoundWorktree | EffectWorktreeRegistry | EffectWorktreeAllocation | EffectWorktreeIntegration | EffectSleep | EffectCommands | EffectConsole | EffectNotifications | EffectActor | EffectReflect deriving (Show, Eq)",
