...
pub fn forks_decl() -> crate::EffectDecl {
    crate::EffectDecl {
        ...
        constructors: &[
            ...
            "ForksStartWith :: Text -> (Int -> Eff childEffs ()) -> Int -> ActorLaunchRole -> ActorEffectProfile -> [Text] -> Maybe WorktreeSpec -> DirtyPolicy -> [ActorEffectKey] -> Maybe ForkEffort -> Maybe (Int, Int) -> Maybe Text -> ForkContext -> Forks (Either Text ((Int, Int, Text), WorktreeHandle))",
