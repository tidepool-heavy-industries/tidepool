...
//! in `bridge/haskell/src/Tidepool/GhcPipeline.hs`, which share the one
...
//! `bridge/haskell/src/Tidepool/Timing.hs`'s flat-phase doc, restated here since the
...
/// existing gated-diagnostics discipline (bridge/haskell/CLAUDE.md's Diagnostics
