...
# Prepared-STG corpus evidence is a separate native projection/execution
# stage. It runs only after the ordinary fixture freshness contract succeeds;
# it never invokes the retired Core evaluator.
